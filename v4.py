...
max_iters = 3000 #how many iterations in total to train for?
...
n_embd = 32 #dimension of the token embeddings
...
class MultiHeadAttention(nn.Module):
    ...
    def forward(self, x):
        ...
        out = self.proj(out) # project back to the original dimension
...
class BigramLanguageModel(nn.Module):
    ...
    def __init__(self):
        ...
        self.blocks = nn.Sequential(
            Block(n_embd, n_head=4), # 4 heads of 8-dimensional self-attention
            Block(n_embd, n_head=4), # another block for more complexity
            Block(n_embd, n_head=4)  # a third block for even more complexity
        )
